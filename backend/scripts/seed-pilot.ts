...
async function main(): Promise<void> {
  ...
  const productData = {
    ...
    storeId: store.id,
    materials: {
      primary: "Madera maciza estacionada",
      ...
      finish: "Patas de guatambú con terminación natural",
      certifications: [],
    ...
    warranty: {
      ...
      conditions: ["Presentar comprobante de compra."],
      exclusions: ["Daños por humedad, mascotas o uso inadecuado"],
    },
    logistics: {
      deliveryTimeDays: { min: 7, max: 12 },
      deliveryType: "home",
      deliveryNote: "A coordinar directamente con la mueblería",
      shippingZones: ["Córdoba Capital", "Gran Córdoba"],
      assembly: { included: false, difficulty: "professional" },
      shipsPackaged: true,
      packaging: {
        piecesCount: 1,
        recyclable: true,
