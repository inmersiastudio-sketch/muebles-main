export const mockProducts: any[] = [
  {
    id: 1, slug: "scandi-sofa-premium", name: "Scandi Sofa Premium 3 Cuerpos Tapizado En Lino Anti-manchas Color Gris Claro",
    price: 850000, description: "Diseño nórdico, máximo confort.",
  ...
  {
    id: 2, slug: "eames-lounge-chair", name: "Eames Lounge Chair Cuero Genuino Madera Nogal Reposera Clásica",
    price: 1299000, description: "Clásico del diseño moderno.",
  ...
  {
    id: 3, slug: "nordic-oak-table", name: "Nordic Oak Table Mesa De Comedor 6 Puestos Roble Macizo Natural",
    price: 450000, description: "Mesa de comedor en roble macizo.",
  ...
  {
    id: 4, slug: "velvet-cloud-sofa", name: "Velvet Cloud Sofa 3 Cuerpos Terciopelo Verde Esmeralda",
    price: 950000, description: "Sofá de terciopelo verde esmeralda.",
  ...
  {
    id: 5, slug: "minimalist-bed-frame", name: "Minimalist Bed Frame Cama Matrimonial Cabecera Tapizada Lino",
    price: 320000, description: "Cama matrimonial con cabecera tapizada.",
  ...
  {
    id: 6, slug: "modern-floor-lamp", name: "Modern Arched Floor Lamp Lámpara De Pie Arco Regulable Mármol",
    price: 189000, description: "Lámpara de pie con arco regulable.",
  ...
  {
    id: 7, slug: "carrara-coffee-table", name: "Carrara Marble Coffee Table Mesa Centro Mármol Patas Doradas",
    price: 450000, description: "Mesa de centro en mármol de Carrara.",
  ...
  {
    id: 8, slug: "scandinavian-accent-chair", name: "Scandinavian Accent Chair Silla De Acento Patas Roble Gris",
    price: 295000, description: "Silla de acento con patas de roble.",
